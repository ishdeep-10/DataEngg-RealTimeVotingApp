...
if __name__ == "__main__":
    checkpoints_path1 = "C:/Users/acer/Desktop/Projects/RealTimeElectionsEngg/checkpoints/checkpoints1"
    checkpoints_path2 = "C:/Users/acer/Desktop/Projects/RealTimeElectionsEngg/checkpoints/checkpoints2"
    
    os.makedirs(checkpoints_path1, exist_ok=True)
    os.makedirs(checkpoints_path2, exist_ok=True)
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars",
                     "Users/acer/Desktop/Projects/RealTimeElectionsEngg/postgresql-42.7.3.jar")  # PostgreSQL driver
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", checkpoints_path1) \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", checkpoints_path2) \
        .outputMode("update") \
        .start()
